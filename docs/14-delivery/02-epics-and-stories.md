...
| Story | AC |
|-------|-----|
| US-100 Create lead | Lead appears in list with source/status (PROC-crm.createLead) |
| US-101 Convert lead | Conversion creates person; lead status converted; history preserved (Flow 03) |
...
| Story | AC |
|-------|-----|
| US-110 CSV import | Import job completes; errors reported per row (Flow 09) |
