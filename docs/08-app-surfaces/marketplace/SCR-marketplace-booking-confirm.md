...
SCR-marketplace-booking-confirm

## Route

`/discover/booking/:id/confirmation`
...
Domain actions per Booking Confirmation — see PROC catalog.
...
See permission matrix for marketplace.
