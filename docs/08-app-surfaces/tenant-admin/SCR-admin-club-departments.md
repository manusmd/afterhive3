...
SCR-admin-club-departments

## Route

`/app/:tenantSlug/club/departments`
...
Domain actions per Departments — see PROC catalog.
...
See permission matrix for tenant_admin.
