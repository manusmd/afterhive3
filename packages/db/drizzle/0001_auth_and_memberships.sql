...
DROP TYPE IF EXISTS "user_status";--> statement-breakpoint
...
ALTER TABLE "role_assignments" ADD CONSTRAINT "role_assignments_membership_id_tenant_memberships_id_fk" FOREIGN KEY ("membership_id") REFERENCES "public"."tenant_memberships"("id") ON DELETE cascade ON UPDATE no action;
